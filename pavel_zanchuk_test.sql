...
--
-- Host: localhost:8889
-- Generation Time: Mar 08, 2019 at 04:28 AM
...
--
-- Database: `pavel_zanchuk_test`
--
CREATE DATABASE IF NOT EXISTS `pavel_zanchuk_test` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `pavel_zanchuk_test`;
